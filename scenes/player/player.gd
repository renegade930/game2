...
func _process(_delta):
	...
	if Input.is_action_pressed("Shoot") and can_laser and Globals.laser_amount > 0:
	...
	if Input.is_action_pressed("Grenade toss") and can_grenade and Globals.grenade_amount > 0:
